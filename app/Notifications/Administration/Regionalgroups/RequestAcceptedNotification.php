    ...
    */
    public function toBroadcast($notifiable)
    {
        return new BroadcastMessage([
            ...
            'message' => 'Die Anfrage an die Regionalgruppe '.$this->_regionalgroup->name.' wurde angenommen.',
    ...
    public function toDatabase($notifiable)
    {
        return [
            'title' => 'Regionalgruppenanfrage',
            'message' => 'Die Anfrage an die Regionalgruppe '.$this->_regionalgroup->name.' wurde angenommen. Bitte erlaube bis zu 12h bis alle Systeme die Änderungen übernommen haben.',
