...
@section('component')
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-12">
                        ...
                        <p class="pb-20 text-white">
                            Suche nach einem Callsign, einer CID oder einem ICAO
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="section-gap" id="aerodromes">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('statistics.flight.search') }}" method="POST" class="form-area">
                            @csrf
                            <div class="row">
                                <div class="col-12 form-group">
                                    <input type="text" name="searchString" placeholder="DLH****, 10000010, EDDF" class="common-input form-control">
                                </div>
                                <div class="col-12 form-group">
                                    <label>From:</label>
